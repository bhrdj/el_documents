...
### 04_merged/ (potential)
**Description**: Merge multi-part chapters (e.g., chapter_05_part1 + chapter_05_part2)
...
1. **Create numbered folder**: `mkdir output/chapters/NN_stagename/`
...
diff output/chapters/00_raw/chapter_2.md output/chapters/02_removedbullets/chapter_02.md

# Count unicode bullets in each stage
grep -r "●\|○\|■" output/chapters/00_raw/ | wc -l
grep -r "●\|○\|■" output/chapters/02_removedbullets/ | wc -l
```
